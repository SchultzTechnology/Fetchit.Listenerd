...
Write-Host "  docker exec -it fetchit-combined listenerd --show" -ForegroundColor Cyan
Write-Host "  docker exec -it fetchit-combined listenerd --delete" -ForegroundColor Cyan
Write-Host ""
